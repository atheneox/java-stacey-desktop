...
import com.atheneox.horizontefrances.views.*;
import com.atheneox.horizontefrances.controllers.ModelController;
import javax.swing.JOptionPane;

public class Jif_ModelTires extends javax.swing.JInternalFrame {

    private static final long serialVersionUID = 1L;
    private ModelController modelController;
    
    public Jif_ModelTires() {
        initComponents();
...
//        modelController.isiTable();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Administración de modelos");
        setToolTipText("Administración de modelos");
