...
public class Jif_StatusLocked extends javax.swing.JInternalFrame {
    private static final long serialVersionUID = 1L;
    private LockedController lockedController;
    
    public Jif_StatusLocked() {
        initComponents();
        lockedController = new LockedController(this);
        lockedController.isiTable();
    }
    ...
    private void initComponents() {
        ...
        Jtbl_Locked = new javax.swing.JTable();
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Estado Bloqueado");
        setToolTipText("Estado Bloqueado");
        ...
        Jtbl_Locked.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        Jtbl_Locked.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Jtbl_LockedMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(Jtbl_Locked);
    ...
    private void Jtbl_LockedMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Jtbl_LockedMouseClicked
        lockedController.getDataField();
    }//GEN-LAST:event_Jtbl_LockedMouseClicked
    ...
    private javax.swing.JTable Jtbl_Locked;
    ...
    public javax.swing.JTable getJtbl_Locked() {
        return Jtbl_Locked;
    }
